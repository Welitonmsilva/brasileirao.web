...
namespace Brasileirao.web.Controllers
{
    public class CidadesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,nome,populacao")] Cidade cidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,nome,populacao")] Cidade cidade)
        {
            if (id != cidade.Id)
            {
                return NotFound();
